...
/* Anatomy HTML click functions  */
		...
		$("#ss_AT_head").click(function() {	
			if (ss_AT_start == false) {
				...
				$("#ss_AT_anatomyImages").attr('src', 'ss_AT_anatomy_hats.png');
		...
		$("#ss_AT_sunglasses").click(function() {
			...
			if (ss_AT_start == false) {
				...
				$("#ss_AT_anatomyImages").attr('src', 'ss_AT_anatomy_sunGlasses.png');
		...
		$("#ss_AT_shirts").click(function() {
			if (ss_AT_start == false) {
				...
				$("#ss_AT_anatomyImages").attr('src', 'ss_AT_anatomy_shirts.png');											
		...
		$("#ss_AT_moneyBelt").click(function() {	
			if (ss_AT_start == false) {
				...
				$("#ss_AT_anatomyImages").attr('src', 'ss_AT_anatomy_moneyBelt.png');
		...
		if (ss_AT_start == false) {
				...
				$("#ss_AT_anatomyImages").attr('src', 'ss_AT_anatomy_passport.png');
		...
		$("#ss_AT_shoes").click(function() {
			if (ss_AT_start == false) {
				...
				("#ss_AT_anatomyImages").attr('src', 'ss_AT_anatomy_boots.png');
		...
		$("#ss_AT_poncho").click(function() {	
			if (ss_AT_start == false) {
				...
				$("#ss_AT_anatomyImages").attr('src', 'ss_AT_anatomy_poncho.png');
															
				$("#ss_AT_anatomySubHead").html('Poncho / Vest');
					
				$("#ss_AT_anatomyText").html('<h3 class="ss_subhead_2">Poncho:</h3><br/ > Not just for water protection, ponchos can be converted to an overhead shelter or as a ground sheet. <br /> <img src="ss_AT_anatomy_vest2B.png" width="230" height="75" /> <h3 class="ss_subhead_2">Travel Vest:</h3><br/ > Best option is the travelers vest, meant for lighter packing; this type of vest has pockets and compartments for items like lip balm, cameras, and bandanas. <br /> <img src="ss_AT_anatomy_vest2B.png" width="230" height="75" /> <br />  <h3 class="ss_subhead_2">Fleece Vest:</h3><br /> Vests are often preferred by high-energy, high-metabolism types who understand their tolerance for cold and need a just-enough insulation buffer for their core. <br/ >');
		...
		$("#ss_AT_backPack").click(function() {		
			if (ss_AT_start == false) {
				...
				$("#ss_AT_anatomyImages").attr('src', 'ss_AT_anatomy_backPack.png');
		...
		$("#ss_AT_underwear").click(function() {	
			if (ss_AT_start == false) {
				...
				$("#ss_AT_anatomyImages").attr('src', 'ss_AT_anatomy_boxers.png');
		...
		$("#ss_AT_electronics").click(function() {
			if (ss_AT_start == false) {
				...
				$("#ss_AT_anatomyImages").attr('src', 'ss_AT_anatomy_camera.png');						
		...
		$("#ss_AT_firstAid").click(function() {	
			if (ss_AT_start == false) {
				...
				$("#ss_AT_anatomyImages").attr('src', 'ss_AT_anatomy_cross.png');				
...
-------------------------------------------------------------------------------- */
		...
		$("#ss_AT_alligatorWrest").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportAlligator.png');	
		...
		$("#ss_AT_bananaBoat").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportBambooRaft.png');	
		...
		$("#ss_AT_bucketText").html("<p><b>Yu Long River, China<br /><br /></b> Bamboo rafting is mostly known in Asian countries like Thailand. It is very simply, floating down the water on-top of a bamboo raft. You sit on top of a long, narrow and thin raft as specialized guides uses long bamboo paddles to lazily float you down the river.   </p>");
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportBananaBoat.png');	
		...
		$("#ss_AT_battleReenact").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportBattle.png');	
		...
		$("#ss_AT_bigFootSki").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportBigFootSki.png');	
		...
		$("#ss_AT_blackWaterRaft").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportBlackWaterRaft.png');	
		...
		$("#ss_AT_blokart").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportBloKart.png');		
		...
		$("#ss_AT_bouldering").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportBouldering.png');		
		...
		$("#ss_AT_bob").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportBOB.png');		
		...
		$("#ss_AT_bridgeSwing").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportBridgeSwing.png');		
		...
		$("#ss_AT_bungeeSwoop").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportBungeeSwing.png');		
		...
		$("#ss_AT_canopyWalk").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportCanopy.png');		
		...
		$("#ss_AT_crossCountrySki").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportCrossCountrySki.png');		
		...
		$("#ss_AT_cycleTouring").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportCycleTour.png');		
		...
		$("#ss_AT_duneBashing").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportDuneBash.png');			
		...
		$("#ss_AT_extremeIron").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportIroning.png');			
		...
		$("#ss_AT_skiStunting").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportSkiStunt.png');			
		...
		$("#ss_AT_heliSki").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportHeliSki.png');			
		...
		$("#ss_AT_iceGoKart").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportGoKart.png');			
		...
		$("#ss_AT_jousting").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportJousting.png');			
		...
		$("#ss_AT_mountaineering").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportMountain.png');			
		...
		$("#ss_AT_orienteering").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportOrient.png');			
		...
		$("#ss_AT_riverBuggying").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportRiverBuggy.png');			
		...
		$("#ss_AT_seaCanoe").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportSeaCanoe.png');				
		...
		$("#ss_AT_swimOrcas").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportOrca.png');				
		...
		$("#ss_AT_swimElephants").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportElephants.png');		
		...
		$("#ss_AT_viaFerrata").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportViaFerratta.png');		
		...
		$("#ss_AT_wrestling").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportWrestle.png');			
		...
		$("#ss_AT_yachting").click(function() {	
			...
			$("#ss_AT_extremeSport_icon img").attr('src','ss_AT_sportYacht.png');		
